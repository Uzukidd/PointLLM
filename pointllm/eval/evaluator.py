...
class OpenAICloseSetClsEvaluator(OpenAIOpenFreeFormClsEvaluator):
    ...
    def evaluate_result(self, result):
        ...
        messages = [
            {"role": "user", "content": self.gpt_prompt.format(model_output=model_output)}]
        ...
        accuracy, cls_result, cls_label, reason = self.parse_gpt_response_evaluate(
            gpt_response, ground_truth)  # return 0, "INVALID", gpt_response if not valid
    ...
    def print_results(self):
        ...
        print(f"Correct Predictions: {self.correct_predictions}")
        print(
            f"Invalid Correct Predictions: {self.invalid_correct_predictions}")
        print(f"Invalid Responses: {self.invalid_responses}")
...
def start_evaluation(results, output_dir, output_file, eval_type="open-free-form-classification", model_type="gpt-3.5-turbo-0613",
    ...
    if eval_type == "open-free-form-classification":
        ...
        evaluator = localLLaMA_close_set_cls_evaluator(
            results, output_dir, output_file)
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_type", type=str, default="gpt-4-0613", choices=[
                        "gpt-3.5-turbo-0613", "gpt-3.5-turbo-1106", "gpt-4-0613", "gpt-4-1106-preview"], help="Type of the model used to evaluate.")
    ...
    parser.add_argument("--eval_type", type=str, choices=["modelnet-close-set-classification",
                        "open-free-form-classification", "object-captioning"], default="object-captioning")
